...
public class AirbridgeUnity
{
    ...
    [DllImport("__Internal")]
    private static extern void native_click(string trackingLink, string deeplink, string fallback);
    [DllImport("__Internal")]
    ...
    {
        native_click(trackingLink, deeplink, fallback);
    }
    ...
    public static void ClickTrackingLink(string trackingLink, string deeplink = null, string fallback = null)
    {
        airbridge.CallStatic("clickTrackingLink", trackingLink, deeplink, fallback);
    }
